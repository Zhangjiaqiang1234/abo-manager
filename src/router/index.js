...
export const asyncRouterMap = [
  {
    ...
    children: [
      ...
      { path: '/management/Banner/create', component: () => import('@/views/management/Banner/create'), name: 'createBanner', meta: { title: 'createBanner', noCache: true }, hidden: true },
      { path: '/management/Banner/edit/:id(\\d+)', component: () => import('@/views/management/Banner/edit'), name: 'editBanner', meta: { title: 'editBanner', noCache: true }, hidden: true },
